...
using DepartmentStoreOne.Base.Model.Cart;
using DepartmentStoreOne.Base.Model.Catalog;
using DepartmentStoreOne.Base.Model.Common;
using DepartmentStoreOne.Base.Model.Customer;
using DepartmentStoreOne.Base.Model.Inventory;
using DepartmentStoreOne.Base.Model.Order;
using DepartmentStoreOne.Base.Model.Pricing;
using DepartmentStoreOne.Base.Model.Quote;
using DepartmentStoreOne.Base.Model.Security;
using DepartmentStoreOne.Base.Model.StaticContent;
using DepartmentStoreOne.Base.Model.Stores;
...
namespace DepartmentStoreOne.Base.Model
{
    ...
    public partial class WorkContext : IDisposable, ICloneable
    {
        ...
        /// <summary>
        /// Represent current Base datetime in UTC (may be changes to test in future or past events)
        /// </summary>
        ...
        public BaseNotification BaseNotification { get; set; }
        public BaseNotification Notification => BaseNotification;
